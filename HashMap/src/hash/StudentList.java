...
public class StudentList extends Hashtable<String, Student>{
    ...
    public boolean loadFromFile(String filename){
        try{    //uing intermediate class beween text and binary streams
    ...
    public boolean saveToFile(String filename){
        try{    //using intermediate class between text and binary streams
            ...
            while(it.hasNext()){
                ...
                pw.print(st);   //write a student to file
            }
            ...
            e.printStackTrace();    //printingg called methods in tack
        }
        return false;
    }
    ...
    public void updateStudent(){
        ...
        System.out.println("Enter sutdent code for updating: ");
        code = sc.nextLine().toUpperCase();
        Student st = this.search(code);
        if(st == null) System.out.println("This code doesn't exist");
        else st.update();
