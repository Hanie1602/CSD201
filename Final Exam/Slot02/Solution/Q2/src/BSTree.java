...
public class BSTree {
    ...
    */
    ...
    public void breadthWithContraints(Node p, RandomAccessFile f) throws Exception {
        if(p == null) 
            return;
        Queue q = new Queue();
        q.enqueue(p);
...
//    }   
    ...
    public void breadthF4(Node p, RandomAccessFile f) throws Exception {
        if(p == null) 
            return;
        Queue q = new Queue();
        q.enqueue(p);
